...
<title>New Academic Project - Andromeda</title>
<link href="../css/academicprojects.css" type="text/css" rel="stylesheet" media="screen">
      ...
      <div class="well">
        ...
        <div id="projects" class="collapse in">
          <ul class="nav nav-pills nav-stacked list-group collapse-div">
            ...
            <li><a class="btn-dropdown-item" href="newproject.php"> <span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;Start Academic Project</a></li>
          </ul>
        </div>
     ...
     <!-- InstanceBeginEditable name="Main-body" -->
      <div id="projectlist" class="panel panel-default">
        ...
        <div class="panel-body panel-body-custom"> <span id="notice"></span>
        	<form id="newacademic-form" role="form" method="post" action="">
            	...
            	<div>
                	<div class="form-group">
                        <label for="pdesc">Details</label>
                        <textarea name="pdesc" cols="200" rows="10"></textarea>
                    </div>
                </div>
                <div class="form-group">
                	<label for="purl">Project URL</label>
                    <input type="text" id="purl" name="purl" class="form-control" placeholder="GitHub Repository/SVN etc."/>
                </div>
                <div class="form-group">
                	<label for="ptech">Related Technologies</label>
                    <input class="form-control" type="text" id="ptech" name="ptech"/>
                </div>
                ...
                <div class="form-group">
                	<label for="pmembers">Add Members</label>
                    <button id="addmembers-btn" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus-sign"></span></button>
                    <div id="memberslist-div">
                    	<!-- content is included through scripts -->
                        <span class="note">No members added</span>
                    </div>
                </div>
